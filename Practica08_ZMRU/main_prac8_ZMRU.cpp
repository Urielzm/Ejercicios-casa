...
{	
	float vertices[] = {
		...
		//superior
		 1.0f,  0.5f, -1.0f, 0.5f,  1.0f, // top right
		 1.0f,  0.5f,  1.0f, 0.5f,  0.66f, // bottom right
		-1.0f,  0.5f,  1.0f, 0.25f, 0.66f, // bottom left
		-1.0f,  0.5f, -1.0f, 0.25f, 1.0f,  // top left 
		...
		/*//frontal2
		2.0f, 0.5f, 2.0f,		0.5f, 0.66f, 	// top right 
		2.0f, -0.5f, 2.0f,		0.5f, 0.33f, 	// bottom right
		-2.0f, -0.5f, 2.0f,		0.25f, 0.33f, 	// bottom left
		-2.0f, 0.5f, 2.0f,		0.25f, 0.66f, 	// top left
		//trasera2
		2.0f, 0.5f, -2.0f,		1.0f, 0.66f, 	// top right 
		2.0f, -0.5f, -2.0f,		1.0f, 0.33f, 	// bottom right
		-2.0f, -0.5f, -2.0f,	0.75f, 0.33f, 	// bottom left
		-2.0f, 0.5f, -2.0f,		0.75f, 0.66f, 	// top left

		//izquierda2
		-2.0f, 0.5f, 2.0f,		0.25f, 0.66f, 	// top right 
		-2.0f, -0.5f, 2.0f,		0.25f, 0.33f, 	// bottom right
		-2.0f, -0.5f, -2.0f,	0.0f, 0.33f, 	// bottom left
		-2.0f, 0.5f, -2.0f,		0.0f, 0.66f, 	// top left
		//derecha2
		2.0f, 0.5f, -2.0f,		0.75f, 0.66f, 	// top right
		2.0f, -0.5f, -2.0f,		0.75f, 0.33f, 	// bottom right
		2.0f, -0.5f, 2.0f,		0.5f, 0.33f, 	// bottom left
		2.0f, 0.5f, 2.0f,		0.5f, 0.66f, 	// top left*/
		//agregamos 16 vertices
		//tablero
		...
		-0.5f, 0.51f, 1.5f,	0.0f, 0.0f,
		-0.5f, 0.51f, 1.25f,	0.0f, 1.0f,
		//aqui termina primer linea horizontal
		//levamos 56 vertices.
	...
	unsigned char *data = stbi_load("Texturas/madera.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
		// IMPORTANT note
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	// load image, create texture and generate mipmaps
	data = stbi_load("Texturas/aj.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
...
void display(void)
{
	...
	glActiveTexture(GL_TEXTURE);//creamos la segunda textura
	glBindTexture(GL_TEXTURE_2D, texture2);//atamos la textura
	projectionShader.setInt("texture2", 1);
	...
	/*glDrawArrays(GL_TRIANGLE_FAN, 280, 4);
	glDrawArrays(GL_TRIANGLE_FAN, 284, 4);
	glDrawArrays(GL_TRIANGLE_FAN, 288, 4);
	glDrawArrays(GL_TRIANGLE_FAN, 292, 4);*/
