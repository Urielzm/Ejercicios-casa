...
void display(void)
{
	...
	Shader projectionShader("shaders/shader_cambioColor.vs", "shaders/shader_cambioColor.fs");
	...
	projectionShader.setVec3("color", glm::vec3(0.0f, 0.0f, 0.0f));
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //A lonely c
	projectionShader.setVec3("color", glm::vec3(0.0f, 0.0f, 0.0f));
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //A lonely c
