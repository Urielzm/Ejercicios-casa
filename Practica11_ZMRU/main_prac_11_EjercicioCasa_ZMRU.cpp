...
/*-------------Controles: p -->  Pausa ------------------------------
                          o -->  Reversa----------------------------
						  l --> Adelante----------------------------
Al inicio el coarrito se mueve hacia delante, presionas o y se va hacia 
atras, presionas l y se va hacia delante-----------------------------*/
	...
	if (play) {
		if (r) {
			if (estado == 0) {// estado A
				rotKit_y = 180;
				if (movKit_z > -80) {// sigo en el estado  A
					movKit_z += -1.0f;
				}
				else {//ya llegue al limite transicion al estado 
					estado = 9;
				}
			}
			if (estado == 1) {
			...
			if (estado == 4) {
				...
				if (movKit_z > 30) {
					...
					estado = 3;//regreso al estado en del inicoo
				}
			...
			if (estado == 5) {
				...
				if (movKit_x > 140) {
					...
					estado = 4;//regreso al estado en del inicoo
				}
			...
			if (estado == 6) {
				...
				if (movKit_z < 150) {
					...
					estado = 5;//regreso al estado en del inicoo
				}
			}
			if (estado == 7) {
				rotKit_y = 90;
				if (movKit_x < 180) {
					...
					estado = 6;//regreso al estado en del inicoo
				}
			...
			if (estado == 8) {
				...
				if (movKit_z > -150) {
					...
					estado = 7;//regreso al estado en del inicoo
				}
			...
			if (estado == 9) {
				...
				if (movKit_x < 90) {
					...
					estado = 8;//regreso al estado en del inicoo
				}
			...
			if (estado == 1) {
				rotKit_y = 90;
				if (movKit_x < 60) {// sigo en estado B
					movKit_x += 1.0f;
					//printf("%f \n", movKit_x);
				}
				else {// estado C
			...
			if (estado == 2) {
				rotKit_y = 180;
				if (movKit_z > 30) {//sigo en estado c
					movKit_z += -1.0f;
					//printf("%f \n", movKit_x);
				}
				else {
			...
			if (estado == 8) {
				...
				if (movKit_z < -80) {
					...
					estado = 9;//regreso al estado en del inicoo
				}
